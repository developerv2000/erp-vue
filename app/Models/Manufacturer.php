    ...
    */
    ...
    public static function getDefaultMADTableHeadersForUser($user)
    {
        ...
        array_push(
            ...
            ['title' => 'Country', 'key' => 'country_id', 'order' => $order++, 'width' => 144, 'visible' => 1, 'sortable' => true],
            ...
            ['title' => 'Category', 'key' => 'category_id', 'order' => $order++, 'width' => 104, 'visible' => 1, 'sortable' => true],
            ['title' => 'Status', 'key' => 'active', 'order' => $order++, 'width' => 106, 'visible' => 1, 'sortable' => true],
            ['title' => 'Important', 'key' => 'important', 'order' => $order++, 'width' => 100, 'visible' => 1, 'sortable' => true],
            ['title' => 'Product class', 'key' => 'product_classes_name', 'order' => $order++, 'width' => 114, 'visible' => 1, 'sortable' => false],
            ['title' => 'Zones', 'key' => 'zones_name', 'order' => $order++, 'width' => 54, 'visible' => 1, 'sortable' => false],
            ['title' => 'Blacklist', 'key' => 'blacklists_name', 'order' => $order++, 'width' => 120, 'visible' => 1, 'sortable' => false],
            ['title' => 'Presence', 'key' => 'presences_name', 'order' => $order++, 'width' => 128, 'visible' => 1, 'sortable' => false],
            ['title' => 'Website', 'key' => 'website', 'order' => $order++, 'width' => 180, 'visible' => 1, 'sortable' => false],
            ['title' => 'About company', 'key' => 'about', 'order' => $order++, 'width' => 240, 'visible' => 1, 'sortable' => false],
            ['title' => 'Relationship', 'key' => 'relationship', 'order' => $order++, 'width' => 200, 'visible' => 1, 'sortable' => false],
            ['title' => 'Comments', 'key' => 'comments_count', 'order' => $order++, 'width' => 132, 'visible' => 1, 'sortable' => false],
            ['title' => 'Last comment', 'key' => 'last_comment_body', 'order' => $order++, 'width' => 240, 'visible' => 1, 'sortable' => false],
            ['title' => 'Comments date', 'key' => 'last_comment_created_at', 'order' => $order++, 'width' => 116, 'visible' => 1, 'sortable' => false],
