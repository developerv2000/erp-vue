...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Предоставленное значение :attribute появилось в утечке данных. Пожалуйста, выберите другое значение для :attribute.',
    ],
    ...
    */
    ...
    'custom' => [
        // Administration
        'users' => [
            'user_is_in_use' => 'Пользователь :name используется, пожалуйста замените его другим пользователем и попробуйте заново.',
        ],

        // MAD
        'ivp' => [
            'unique_on_create' => 'Такой продукт уже существует: доза: :dosage, упаковка: :pack, МОК: :moq.',
            'unique_on_edit' => 'Продукт с таким производителем, МНН, формой, дозой, упаковкой, МОК и сроком годности уже существует.',
        ],

        'vps' => [
            'unique_on_create' => 'Процесс для текущей страны уже существует: :country.',
            'unique_on_edit' => 'Процесс с таким продуктом, страной поиска, ДРУ и ТМ уже существует.',
        ],

        'process_status_history' => [
            'is_active_history' => 'Текущая история процесса не может быть удалена.',
        ],

        'kvpp' => [
            'unique' => 'Запись с такой МНН, формой, дозой, упаковкой, страной и РУ уже существует.',
        ],

        'meetings' => [
            'unique' => 'Встреча на такой год, с таким производителем уже существует.',
        ],

        'process' => [
            'marked_as_ready_for_order_has_orders' => 'Процесс не может быть размечен, так как у него уже есть заказы.',
        ],
    ],
