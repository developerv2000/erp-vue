...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'kvpp' => [
            'unique' => 'КВПП с таким МНН, формой, дозой, упаковкой, страной и РУ уже существует.',
        ],
        ...
        'users' => [
            'is_in_use' => 'Пользователь используется, пожалуйста замените его другим пользователем и попробуйте заново.',
        ],
        ...
        'misc_models' => [
            'record_is_in_use' => '":name" не может быть удалён, так как используется другими таблицами.',
        ],
    ],
