...
const defaultFilters = {
    // Date ranges
    date_of_sending_new_layout_to_manufacturer: null,
    date_of_receiving_print_proof_from_manufacturer: null,
    layout_approved_date: null,
    created_at: null,
    updated_at: null,
...
const API_URL = route('api.dd.order-products.get');

export const useDDOrderProductsTableStore = defineStore('DDOrderProductsTable', {
    state: () => ({
        records: [],
        loading: false,
    ...
    actions: {
        ...
        initFromInertiaPage(page) {
            ...
            // Normalize filters
            normalizeNumbersFromQuery(this.filters, query, ['new_layout', 'order_id']);
            ...
            normalizeDateRangesFromQuery(this.filters, query, ['date_of_sending_new_layout_to_manufacturer', 'date_of_receiving_print_proof_from_manufacturer', 'layout_approved_date', 'created_at', 'updated_at']);
        ...
        toQuery() {
            const rawQuery = {
                ...
                // Filters
                ...this.filters,
                ...normalizeDateRangesToQueryFormat(this.filters, ['date_of_sending_new_layout_to_manufacturer', 'date_of_receiving_print_proof_from_manufacturer', 'layout_approved_date', 'created_at', 'updated_at']),
            };
