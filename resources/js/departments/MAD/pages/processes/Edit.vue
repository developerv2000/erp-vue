...
import ProcessesEditForm from "./partials/ProcessesEditForm.vue";

const page = usePage();
const { t } = useI18n();

const title = computed(() => t("pages.VPS") + " — " + page.props.record.title);
</script>
    ...
    <MainLayout :title="title">
        <PageIntro>
            <template #breadcrumbs>
                <InertiaBreadcrumbs :breadcrumbs="page.props.breadcrumbs" />
            </template>
