...
export const useMADProcessesTableStore = defineStore('MADProcessesTable', {
    ...
    actions: {
        ...
        initFromInertiaPage(page) {
            ...
            normalizeMultiIDsFromQuery(this.filters, query, ['product_inn_id', 'manufacturer_id', 'product_form_id', 'country_id', 'status_id', 'status_general_status_id', 'manufacturer_country_id', 'product_class_id', 'marketing_authorization_holder_id']);
