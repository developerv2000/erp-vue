...
const defaultPaginationOptions = {
    page: 1,
    per_page: 50,
    order_by: 'readiness_for_order_date',
...
export const usePLDReadyForOrderProcessesTableStore = defineStore('PLDReadyForOrderProcessesTable', {
    ...
    actions: {
        initFromInertiaPage(page) {
            ...
            normalizeMultiIDsFromQuery(this.filters, query, ['product_inn_id', 'manufacturer_id', 'product_form_id', 'country_id', 'marketing_authorization_holder_id']);
