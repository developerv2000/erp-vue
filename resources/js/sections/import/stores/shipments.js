...
const API_URL = route('api.import.shipments.get');

export const useImportShipmentsTableStore = defineStore('ImportShipmentsTable', {
    state: () => ({
        records: [],
        loading: false,
    ...
    actions: {
        ...
        initFromInertiaPage(page) {
            ...
            // Normalize filters
            normalizeMultiIDsFromQuery(this.filters, query, ['manufacturer_id', 'transportation_method_id', 'destination_id']);
            normalizeDateRangesFromQuery(this.filters, query, ['confirmed_at', 'completed_at', 'arrived_at_warehouse', 'created_at', 'updated_at']);
        ...
        toQuery() {
            const rawQuery = {
                ...
                // Filters
                ...this.filters,
                ...normalizeDateRangesToQueryFormat(this.filters, ['confirmed_at', 'completed_at', 'arrived_at_warehouse', 'created_at', 'updated_at']),
            };
